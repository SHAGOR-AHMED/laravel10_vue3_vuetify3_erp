export default{
    ...
    // solaman badsha role permission
    ...
    isAdmin(){
        return this.checkSingleRole('Admin')
    },

    isEmployee(){
        return this.checkAnyRoleOfArray(['Administrator', 'Employee']);
    },
    isViewAccess(){
    ...
    // solaman badsha role permission end
